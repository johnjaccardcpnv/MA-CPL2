...
screen combat_ui():
    add "bg_combat"
    add player_config["image"] xpos 100 ypos 250 xsize 350
    add boss_config["image"] xpos 1350 ypos 250 xsize 350
    ...
    frame:
        ...
        vbox spacing 10:
            ...
            text "HP: [get_hp_display(player_stats)]/[player_config['max_hp']] PM: [player_stats['mp'] or 0]/[player_config['max_mp']]" size 24
            text "Potions: HPx[potions_hp] PMx[potions_mp]" size 20 color "#44ff44"
    ...
    viewport:
        xpos 80 ypos 650 xsize 1500 ysize 180 mousewheel True scrollbars "vertical"
        vbox:
...
screen player_menu():
    ...
    frame:
        ...
        xpos 100 ypos 700 xsize 1000 ysize 280
        
        vbox spacing 15 xalign 0.5 ypos 20:
            text "VOTRE TOUR" size 40 bold True color "#44ff44" xalign 0.5
                ...
                for i in range(3):
                    ...
                    button:
                        ...
                        vbox xalign 0.5:
                            fixed:
                                xsize 160 ysize 60
                                add spell["image"] xalign 0.5 yalign 0.5
                            text "[spell['name']]" size 20 bold True xalign 0.5 color "#ffffff"
            ...
            hbox spacing 30 xalign 0.5:
                button:
                    ...
                    vbox xalign 0.5:
                        fixed:
                            xsize 160 ysize 60
                            add player_spells[3]["image"] xalign 0.5 yalign 0.5
